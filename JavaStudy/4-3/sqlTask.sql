...
JOIN
goods_table ON stock_table.goods_code = goods_table.goods_code
...
-- [回答]
INSERT INTO goods_table(goods_code, goods_name, price, update_day)VALUES
('M001', 'マフラー', 4500, '2020-08-30');
...
SET 
quantity=10,
update_day='2020-08-30'
WHERE
goods_code='S987' AND store_code='EA01'

-- 8. 7で更新した商品を削除しなさい。※実行後のSELECT結果も貼付すること。
-- [回答]
DELETE FROM stock_table WHERE update_day = '2020-08-30';